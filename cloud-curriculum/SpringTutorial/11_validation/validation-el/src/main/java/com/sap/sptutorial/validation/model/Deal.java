...
import com.sap.sptutorial.validation.validator.ValidateClassExpression;
import com.sap.sptutorial.validation.validator.ValidateClassExpressions;
...
@Getter
@Setter
@ValidateClassExpressions(@ValidateClassExpression(
        value = "#this.availablePerCustomer <= #this.numberAvailable",
        groups = FinalChecks.class,
        message = "Deals available per customer must be smaller then or equal to the overall available deals"))
public class Deal {
